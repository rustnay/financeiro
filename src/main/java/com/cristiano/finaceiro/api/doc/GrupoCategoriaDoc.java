...
public interface GrupoCategoriaDoc {
    ...
    ResponseEntity<HttpResponse> create(@RequestBody GrupoCategoriaRequest request);
    ResponseEntity<HttpResponse> update(@RequestBody GrupoCategoriaRequest request);
